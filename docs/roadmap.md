...
- Local transport-level execute verification for Home Assistant, MQTT, MIoT
  bridge, and Matter bridge.
...
2. Expand MQTT route/payload coverage only when concrete downstream schemas are
   configured.
